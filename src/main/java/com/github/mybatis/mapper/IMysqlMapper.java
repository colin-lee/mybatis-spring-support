...
public interface IMysqlMapper {
   ...
   * SELECT statement, and then invoke FOUND_ROWS() afterward: <br/><br/>
   * mysql&gt; SELECT SQL_CALC_FOUND_ROWS * FROM tbl_name WHERE id &gt; 100 LIMIT 10; <br/>
   * mysql&gt; SELECT FOUND_ROWS(); <br/><br/>
   *
